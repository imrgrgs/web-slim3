...
[![Latest Stable Version](https://poser.pugx.org/imrgrgs/web-slim3/v/stable.svg)](https://packagist.org/packages/imrgrgs/web-slim3) [![Total Downloads](https://poser.pugx.org/imrgrgs/web-slim3/downloads.svg)](https://packagist.org/packages/imrgrgs/web-slim3) ![License](https://poser.pugx.org/imrgrgs/web-slim3/license.svg)
...
```bash
composer create-project imrgrgs/web-slim3 [my-app-name]
```
